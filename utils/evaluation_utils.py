...
def evaluate_policy(env, policy, maximum_episode_length=1000, discount_factor=0.95, nb_episodes=1):
  """
...
def evaluate_episode(env, policy, maximum_episode_length=1000, discount_factor=0.95):
  if use_cuda:
    policy.cuda()
  reward = 0
  df = 1.0
